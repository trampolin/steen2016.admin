...
if [ ! -f ./core/STEEN_Controller.php ]; then
	ln -s ../third_party/community_auth/core/STEEN_Controller.php ./core/STEEN_Controller.php
fi

if [ ! -f ./core/STEEN_Input.php ]; then
	ln -s ../third_party/community_auth/core/STEEN_Input.php ./core/STEEN_Input.php
fi

if [ ! -f ./core/STEEN_Model.php ]; then
	ln -s ../third_party/community_auth/core/STEEN_Model.php ./core/STEEN_Model.php
fi
